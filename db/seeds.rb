...
Dog.create(name: "Cookie", breed: "Corgi", age: 8)
Dog.create(name: "Shina", breed: "Shiba", age: 6)
Dog.create(name: "Ramen", breed: "Shi-poo", age: 4)
Dog.create(name: "Sushi", breed: "Husky", age: 3)
Dog.create(name: "Kobe", breed: "Malmut", age: 10)
